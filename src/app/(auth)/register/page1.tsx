...
//         errors.email = "Only gmail.com and gla.ac.in email addresses are allowed";
//       }
//     }
...
//         formData.role
//       );
//       // On success, ProtectedRoute (requireAuth=false) will auto-redirect based on role
//       if (!success) {
//         // Error toast handled in context, but we might get field-specific errors
//         // Check if we need to handle specific field errors from backend
//       }
//     } catch (error: any) {
...
//                         Only Gmail and GLA University email addresses are accepted
//                       </div>
//                     )}
//                     {fieldErrors.email && (
